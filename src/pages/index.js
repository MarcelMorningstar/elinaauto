...
export default function Home({ home }) {
  ...
  return (
    <Layout titles={[home.title1, home.title2, home.title3, home.title4]}>
      {
      ...
      <h1 className='flex items-center justify-center h-52'><Image className="object-contain" src={imageUrlFor(home.logo).url()} width={300} height={104} alt="logo" /></h1>
      ...
      <section id="about-us">
        <div className='flex flex-col lg:flex-row items-center lg:items-start gap-8 lg:gap-16'>
          <div className='grid grid-cols-3 grid-rows-3 gap-2 sm:gap-3 md:gap-4 w-full sm:w-4/5 md:w-2/3 lg:w-1/2 h-min'>
            <div className='relative aspect-square cursor-pointer' onClick={() => previewImage(imageUrlFor(home.aboutUsImage1).url(), 'image')}>
              <Image className="object-cover" src={imageUrlFor(home.aboutUsImage1).url()} fill sizes="200px" alt="about us image"/>
            </div>
            <div className='relative aspect-square cursor-pointer' onClick={() => previewImage(fileUrlFor(home.aboutUsVideo1).url, 'video')}>
              <Image className="object-cover" src={imageUrlFor(home.aboutUsVideoThumbnail1).url()} fill sizes="200px" alt="about us image"/>
              <MdOutlinePlayCircle className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-2/5 h-2/5 text-background/90 drop-shadow-lg" />
            </div>
            <div className='relative aspect-square cursor-pointer' onClick={() => previewImage(imageUrlFor(home.aboutUsImage2).url(), 'image')}>
              <Image className="object-cover" src={imageUrlFor(home.aboutUsImage2).url()} fill sizes="200px" alt="about us image"/>
            </div>
            <div className='relative aspect-square cursor-pointer' onClick={() => previewImage(fileUrlFor(home.aboutUsVideo2).url, 'video')}>
              <Image className="object-cover" src={imageUrlFor(home.aboutUsVideoThumbnail2).url()} fill sizes="200px" alt="about us image"/>
              <MdOutlinePlayCircle className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-2/5 h-2/5 text-background/90 drop-shadow-lg" />
            </div>
            <div className='relative aspect-square cursor-pointer' onClick={() => previewImage(imageUrlFor(home.aboutUsImage3).url(), 'image')}>
              <Image className="object-cover" src={imageUrlFor(home.aboutUsImage3).url()} fill sizes="200px" alt="about us image"/>
            </div>
            <div className='relative aspect-square cursor-pointer' onClick={() => previewImage(imageUrlFor(home.aboutUsImage4).url(), 'image')}>
              <Image className="object-cover" src={imageUrlFor(home.aboutUsImage4).url()} fill sizes="200px" alt="about us image"/>
            </div>
            <div className='relative aspect-square cursor-pointer' onClick={() => previewImage(imageUrlFor(home.aboutUsImage5).url(), 'image')}>
              <Image className="object-cover" src={imageUrlFor(home.aboutUsImage5).url()} fill sizes="200px" alt="about us image"/>
            </div>
            <div className='relative aspect-square cursor-pointer' onClick={() => previewImage(imageUrlFor(home.aboutUsImage6).url(), 'image')}>
              <Image className="object-cover" src={imageUrlFor(home.aboutUsImage6).url()} fill sizes="200px" alt="about us image"/>
            </div>
            <div className='relative aspect-square cursor-pointer' onClick={() => previewImage(fileUrlFor(home.aboutUsVideo2).url, 'video')}>
              <Image className="object-cover" src={imageUrlFor(home.aboutUsVideoThumbnail3).url()} fill sizes="200px" alt="about us image"/>
              <MdOutlinePlayCircle className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-2/5 h-2/5 text-background/90 drop-shadow-lg" />
            </div>
          </div>

          <div className='w-full lg:w-1/2 py-6 text-center lg:text-left'>
            <h3>{t("common:section1")}</h3>

            <p className="break-words">{ home.aboutUs }</p>
          </div>
        </div>
      </section>
      ...
      <section id="contact-us">
        <div className='flex flex-col lg:flex-row items-center lg:items-start gap-8 xl:gap-16'>
          ...
          <div className='flex justify-center w-full lg:w-1/2'>
            <div className='block w-full lg:h-[500px] aspect-square lg:aspect-auto rounded-3xl bg-slate-900'></div>
          </div>
        </div>
      </section>
    </Layout>
